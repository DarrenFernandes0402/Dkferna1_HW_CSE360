...
public class StaffHomePage {
	...
	public void show(Stage primaryStage) {
		...
		Button userButton = new Button("View All Users");
		userButton.setStyle(
				"-fx-text-fill: black; -fx-font-weight: bold; -fx-border-color: black; -fx-border-width:  1px;");
...
//								indent += 1;
		...
		HBox buttonBox1 = new HBox(10, viewReviewsButton, quitButtonBox, inboxButton, buttonBox2, userButton);
		...
		userButton.setOnAction(a->{
			Stage newStage = new Stage();
			newStage.initStyle(StageStyle.TRANSPARENT);
			new AllUserForStaffList(databaseHelper).show(newStage);
		});
